...
```bash
sudo apt update && rm -rf install.py && wget -qO install.py https://raw.githubusercontent.com/DarkX911/xtreamui-ubuntu24.04full/main/install.py && sudo python3 install.py
```
